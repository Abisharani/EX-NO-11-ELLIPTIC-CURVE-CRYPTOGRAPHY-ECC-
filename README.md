...
int main() {
    ...
    printf("Enter abi's private key: ");
    scanf("%lld", &privateA);
    printf("Enter anu's private key: ");
    scanf("%lld", &privateB);
    publicA = scalarMultiplication(G, privateA, a, p); 
    publicB = scalarMultiplication(G, privateB, a, p); 
    printf("abi's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("anu's public key: (%lld, %lld)\n", publicB.x, publicB.y);
    ...
    printf("Shared secret computed by diviya: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
    printf("Shared secret computed by bagya: (%lld, %lld)\n", sharedSecretB.x, sharedSecretB.y);
...
<img width="812" height="390" alt="image" src="https://github.com/user-attachments/assets/361c1361-35b4-45ce-8061-a04864057462" />
